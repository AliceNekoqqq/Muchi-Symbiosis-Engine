...
export const SYMBIOSIS_VERSION = '1.0.0';
...
export async function mountSymbiosis(){
  ...
  (()=>{
    const VERSION='1.0.0', ROOT_ID='muchi-symbiosis-v100', STYLE_ID='muchi-symbiosis-style-v100';
